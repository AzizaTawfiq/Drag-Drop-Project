...
var Fields = exports.Fields = /*#__PURE__*/function (_Base) {
  ...
  return _createClass(Fields, [{
    ...
    value: function _handleAddProject(event) {
      ...
      var _this$_getInputsValue = this._getInputsValues(titleInput, descInput),
    ...
    value: function _getInputsValues(titleInput, descInput) {
    ...
    value: function _validateInputsValues(titleValue, descValue) {
      ...
      var titleErrorMessage = titleInputRule ? (0, _validation_helpers.handleValidationErrors)(titleInputRule) : '';
      var descErrorMessage = descInputRule ? (0, _validation_helpers.handleValidationErrors)(descInputRule) : '';
      var popupContainer = document.getElementById('popup_container');
      var descPopup = popupContainer.querySelector('.desc_popup');
