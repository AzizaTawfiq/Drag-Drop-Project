...
var Project = exports.Project = /*#__PURE__*/function (_Base) {
  function Project(projectsListId, project) {
    var _this;
    _classCallCheck(this, Project);
    _this = _callSuper(this, Project, ['project-item', projectsListId, true, project.id]);
  ...
  return _createClass(Project, [{
    ...
    value: function _deleteHandler() {
      if (confirm("Are you sure you want to delete this project?")) {
        _ProjectState.projectState.deleteProject(this._project.id);
      }
    }
    ...
    key: "_deleteProject",
    value: function _deleteProject() {
      var deleteBtn = this.element.querySelector('.delete');
      deleteBtn.addEventListener('click', this._deleteHandler.bind(this));
    }
  }]);
}(_Base2.Base);